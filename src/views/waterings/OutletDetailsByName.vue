<template>
  ...
  ODBN: {{ outlet_details_by_name }}
  <br/>
  2: {{outlet_details_by_name.outlet_name}}
  <div class="card-display">
    <OutletDetailsByNameCard
      :key="outlet_details_by_name.id"
      :outlet_details_by_name="outlet_details_by_name"
      class="card"
...
export default {
  ...
  computed: {
    outlet_details_by_name() {
      console.log("ODBN - Computed Outlet By Name: ", this.$store.state.outlet_details_by_name, this.$route.params.outlet_details_by_name)
