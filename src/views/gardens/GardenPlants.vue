  ...
  <div class="plant-list">
    ...
    <span v-if="filteredResults.length > 0">
      <span v-if="requestIndexDetailFlag == true">
        ...
        <span>GPDouble click to Edit</span>
        <div class="cards">
          <GardenPlantCard
...
export default {
  ...
  async mounted() {
    ...
    const result = await axios.get(this.api_url + +this.garden.id);
    this.plants = result.data;
  },
  created() {
    //console.log("Garden Plants Created - Garden ID: ", this.garden)
    this.$store.dispatch("fetchGardenPlants", this.garden.id);
    //console.log("Garden Plants Created - Received: ", this.garden_id)
  ...
  computed: {
    ...
    //plants() {
    //  console.log("Computed plants: ", this.$store.state.plants)
